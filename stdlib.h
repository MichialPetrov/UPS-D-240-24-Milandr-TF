...
_C_LIB_DECL
extern int __taabi_MB_CUR_MAX(void);
_END_C_LIB_DECL

#if __TAABI_PORTABILITY_INTERNAL_LEVEL
  #ifndef __TAABI_PORTABLE
    #define __TAABI_PORTABLE
  #endif

  #define MB_CUR_MAX    (_CSTD __taabi_MB_CUR_MAX())

#else /* __TAABI_PORTABILITY_INTERNAL_LEVEL  */

  #define MB_CUR_MAX    (_ENCODING_CUR_MAX)

#endif /*  __TAABI_PORTABILITY_INTERNAL_LEVEL */
...
__ATTRIBUTES int abs(int);
__ATTRIBUTES void * calloc(size_t, size_t);
__ATTRIBUTES div_t div(int, int);
__ATTRIBUTES void free(void *);
__ATTRIBUTES long labs(long);
__ATTRIBUTES ldiv_t ldiv(long, long);
#if _DLIB_ADD_C99_SYMBOLS
  #ifdef _LONGLONG
    #pragma language=save
    #pragma language=extended
    __ATTRIBUTES long long llabs(long long);
    __ATTRIBUTES lldiv_t lldiv(long long, long long);
    #pragma language=restore
  #endif
#endif /* _DLIB_ADD_C99_SYMBOLS */
__ATTRIBUTES void * malloc(size_t);
__ATTRIBUTES int mblen(const char *, size_t);
__ATTRIBUTES size_t mbstowcs(wchar_t *_Restrict, const char *_Restrict, size_t);
__ATTRIBUTES int mbtowc(wchar_t *_Restrict, const char *_Restrict, size_t);
__ATTRIBUTES int rand(void);
__ATTRIBUTES void srand(unsigned int);
__ATTRIBUTES void * realloc(void *, size_t);
__ATTRIBUTES long strtol(const char *_Restrict, char **_Restrict, int);
__ATTRIBUTES unsigned long strtoul(const char *, char **, int);
__ATTRIBUTES size_t wcstombs(char *_Restrict, const wchar_t *_Restrict, size_t);
__ATTRIBUTES int wctomb(char *, wchar_t);
#if _DLIB_ADD_C99_SYMBOLS
  #ifdef _LONGLONG
    #pragma language=save
    #pragma language=extended
    __ATTRIBUTES long long strtoll(const char *, char **, int);
    __ATTRIBUTES unsigned long long strtoull(const char *, char **, int);
    #pragma language=restore
  #endif
#endif /* _DLIB_ADD_C99_SYMBOLS */

#if __TAABI_PORTABILITY_INTERNAL_LEVEL == 0
...
#endif /* __TAABI_PORTABILITY_INTERNAL_LEVEL == 0 */


__ATTRIBUTES unsigned long __iar_Stoul(const char *, char **, int);
__ATTRIBUTES float __iar_Stof(const char *, char **, long);
__ATTRIBUTES double __iar_Stod(const char *, char **, long);
__ATTRIBUTES long double __iar_Stold(const char *, char **, long);
__ATTRIBUTES long __iar_Stolx(const char *, char **, int, int *);
__ATTRIBUTES unsigned long __iar_Stoulx(const char *, char **, int, int *);
__ATTRIBUTES float __iar_Stofx(const char *, char **, long, int *);
__ATTRIBUTES double __iar_Stodx(const char *, char **, long, int *);
__ATTRIBUTES long double __iar_Stoldx(const char *, char **, long, int *);
#ifdef _LONGLONG
  #pragma language=save
  #pragma language=extended
  __ATTRIBUTES _Longlong __iar_Stoll(const char *, char **, int);
  __ATTRIBUTES _ULonglong __iar_Stoull(const char *, char **, int);
  __ATTRIBUTES _Longlong __iar_Stollx(const char *, char **, int, int *);
  __ATTRIBUTES _ULonglong __iar_Stoullx(const char *, char **, int, int *);
  #pragma language=restore
#endif
...
_END_EXTERN_C
__ATTRIBUTES_CAN_THROW void * bsearch(const void *, const void *, size_t,
                                      size_t, _Cmpfun *);
__ATTRIBUTES_CAN_THROW void qsort(void *, size_t, size_t, _Cmpfun *);
__ATTRIBUTES_CAN_THROW void __qsortbbl(void *, size_t, size_t, _Cmpfun *);
__ATTRIBUTES double atof(const char *);
__ATTRIBUTES int atoi(const char *);
__ATTRIBUTES long atol(const char *);
#if _DLIB_ADD_C99_SYMBOLS
  #ifdef _LONGLONG
    #pragma language=save
    #pragma language=extended
    __ATTRIBUTES long long atoll(const char *);
    #pragma language=restore
  #endif
  __ATTRIBUTES float strtof(const char *_Restrict, char **_Restrict);
  __ATTRIBUTES long double strtold(const char *, char **);
#endif /* _DLIB_ADD_C99_SYMBOLS */
__ATTRIBUTES double strtod(const char *_Restrict, char **_Restrict);
__ATTRIBUTES size_t __iar_Mbcurmax(void);

__ATTRIBUTES int __iar_DLib_library_version(void);
_END_C_LIB_DECL
  ...
  _EXTERN_CPP
    ...
    void * bsearch(const void *, const void *, size_t, size_t, _Cmpfun2 *);
