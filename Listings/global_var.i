...
ModeOfWork MODE, MODE_prev; 
ModeOfCharge MODE_CHARGE;		
Device_Status DStat; 
Status device_status[AMOUNT_STATUS]; 
...
int ADCready_to_calculate=NO; 	 
int ADC_avr_calculate_end=NO; 		

Warning Wrng_I_LOAD, Wrng_U_LOAD, Wrng_U_KAN_D; 
char warning_flag; 
