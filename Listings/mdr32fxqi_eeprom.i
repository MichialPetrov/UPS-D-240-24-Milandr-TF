#line 1 "C:/Programs/Keil v537/Packs/Milandr/MDR32FxQI/1.0/Libraries/SPL/MDR32FxQI/src/MDR32FxQI_eeprom.c"
...
#line 24 "C:/Programs/Keil v537/Packs/Milandr/MDR32FxQI/1.0/Libraries/SPL/MDR32FxQI/src/MDR32FxQI_eeprom.c"
 ...
 static __inline void EEPROM_UpdateDCacheC(void) __attribute__((section("EXECUTABLE_MEMORY_SECTION")));
...
#line 119 "C:/Programs/Keil v537/Packs/Milandr/MDR32FxQI/1.0/Libraries/SPL/MDR32FxQI/src/MDR32FxQI_eeprom.c"
 ...
 void EEPROM_ErasePage(uint32_t Address, EEPROM_Mem_Bank BankSelector)
{
    ...
    for (Offset = 0; Offset < (4 << 2); Offset += 4)
    {
        ...
        ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
        ProgramDelay(((uint32_t)((double)(5) * (8.0) / (8UL))));         
        Command |= ((uint32_t)0x00002000);
        ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
        ProgramDelay(((uint32_t)((double)(40000) * (8.0) / (8UL))));     
        Command &= ~((uint32_t)0x00000400);
        ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
        ProgramDelay(((uint32_t)((double)(5) * (8.0) / (8UL))));         
        Command &= ~(((uint32_t)0x00000040) | ((uint32_t)0x00002000));
        ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
        ProgramDelay(((uint32_t)((double)(1) * (8.0) / (8UL))));         
    }
    ...
    ProgramDelay(((uint32_t)((double)(4000) * (8.0) / (8UL))));          
}
 ...
 void EEPROM_EraseAllPages(EEPROM_Mem_Bank BankSelector)
{
    ...
    for (Offset = 0; Offset < (4 << 2); Offset += 4)
    {
        ...
        Command &= ~((uint32_t)0x00000400);
        ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
        ProgramDelay(((uint32_t)((double)(100) * (8.0) / (8UL))));       
 ...
 void EEPROM_ProgramWord(uint32_t Address, EEPROM_Mem_Bank BankSelector, uint32_t Data)
{
    ...
    Command |= ((uint32_t)0x00002000);
    ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
    ProgramDelay(((uint32_t)((double)(10) * (8.0) / (8UL))));                
    Command |= ((uint32_t)0x00000080);
    ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
    ProgramDelay(((uint32_t)((double)(40) * (8.0) / (8UL))));                
    Command &= ~((uint32_t)0x00000080);
    ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
 ...
 void EEPROM_UpdateDCache(void)
{
 ...
 static __inline void EEPROM_UpdateDCacheC(void)
{
    volatile uint32_t i, tmp;
    volatile uint32_t *ptr_eeprom = (uint32_t *) (((uint32_t)0x08000000));
    
#line 494 "C:/Programs/Keil v537/Packs/Milandr/MDR32FxQI/1.0/Libraries/SPL/MDR32FxQI/src/MDR32FxQI_eeprom.c"
    i = 5;
